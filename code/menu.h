...
#define MENU_TRIGGER_VALUES (MENU_TRIGGER | 4)
#define MENU_TRIGGER_VALUES_EDIT (MENU_TRIGGER | 5)
#define MENU_TRIGGER_MAX MENU_TRIGGER_VALUES
...
#define MENU_VIEW_SIGNALTYPE (MENU_VIEW | 3)
#define MENU_VIEW_TZOOM (MENU_VIEW | 4)
#define MENU_VIEW_VZOOM (MENU_VIEW | 5)
#define MENU_VIEW_VPOS (MENU_VIEW | 6)
#define MENU_VIEW_MAX MENU_VIEW_VPOS
